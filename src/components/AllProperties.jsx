// src/components/AllProperties.jsx
import React, { useState, useEffect } from 'react';
import { fetchProperties } from '../api/properties';

export default function AllProperties({ limit = 6 }) {
  ...
  if (loading) {
    return <p className="text-center py-8">Loading properties…</p>;
  }
  if (error) {
    ...
    <section className="properties__grid section__space py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {propsList.map(prop => (
            <div key={prop.id} className="property__grid__single bg-white rounded shadow">
              ...
              <div className="p-4">
                ...
                <div className="invest__cta__wrapper flex justify-center">
                  <a href={`/details-property/${prop.id}`} className="button button--effect">
                    Invest Now
                  </a>
                </div>
              </div>
