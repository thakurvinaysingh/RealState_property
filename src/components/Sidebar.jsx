    ...
    >
      ...
      <nav className="px-4 space-y-2">
        <ul className="space-y-1">
          {[
            { to: '/dashboard', icon: 'dashboard.png', label: 'Dashboard', active: true },
            { to: '/investment', icon: 'investments.png', label: 'Investments' },
            { to: '/transactions', icon: 'transactions.png', label: 'Transactions' },
            { to: '/withdraw', icon: 'withdraw.png', label: 'Withdraw' },
            { to: '/account', icon: 'account.png', label: 'Account' },
          ].map(item => (
            <li key={item.to}>
              <Link
                to={item.to}
        ...
        <ul>
          <li>
            <button
              ...
              className="flex items-center w-full text-left px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100 transition"
              type="button"
            >
              <img
