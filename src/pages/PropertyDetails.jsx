...
import { fetchPropertyById } from '../api/properties'  // Adjust if needed
...
export default function PropertyDetailsPage() {
  ...
  useEffect(() => {
    ...
    fetchPropertyById(id)
      .then((res) => {
        // If API returns res.data, else just use res if no .data
  ...
  // Demo fallback for missing fields
  const {
    city = 'N/A',
    address = 'N/A',
    bannerImage,
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${bannerImage || '/assets/images/banner/property-details-banner.png'})` }}
      />
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-7 space-y-8">
              {/* Gallery Button */}
              <a href="#gallery" className="button button--effect button--secondary inline-flex items-center">
              ...
              <div className="intro">
                ...
                <p className="flex items-center text-gray-600">
                  <i className="fa-solid fa-location-dot mr-1" /> {address}
                </p>
              </div>
              ...
              <div className="group__two">
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-700">
                  {reasonsToInvest.map((item, i) => (
                    <li key={i} className="flex items-start">
                      <img src="/assets/images/check.png" alt="Check" className="h-5 w-5 mr-2 mt-1" />
                      {item}
                    </li>
                  ))}
                </ul>
                ...
                <div className="flex flex-wrap gap-6">
                  {financialTerms.map((t, i) => (
                    <div key={i} className="terms__single text-center">
                      <img
                        src={t.icon ? t.icon : `/assets/images/icons/loan.png`}
                        alt={t.label}
              ...
              <div className="terms space-y-6">
                ...
                <div className="flex flex-wrap gap-6">
                  {capitalGrowthSplit.map((t, i) => (
                    <div key={i} className="terms__single text-center">
                      <img
                        src={t.icon ? t.icon : `/assets/images/icons/investor.png`}
                        alt={t.label}
                        className="mx-auto mb-2 h-10"
                      />
                      <p className="text-gray-600">{t.label}</p>
              ...
              <div className="owner flex items-start space-x-4">
                <img src={owner.image || "/assets/images/owner.png"} alt="Owner" className="h-24 w-24 rounded-full object-cover" />
                <div>
                  <h5>{owner.title || 'The project owner (borrower)'}</h5>
              ...
              <div className="faq__group space-y-4">
                ...
                <div className="accordion" id="accordionExampleFund">
                  {faq.map(({ question, answer, id: qid, expanded }, i) => (
                    <div key={qid || i} className="accordion-item">
              ...
              <div className="group__one">
                ...
                <p className="text-gray-700">{risks}</p>
                {mapUrl &&
            ...
            <aside className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg space-y-4">
                <div className="countdown__wrapper">
                  ...
                  <div className="countdown font-mono text-2xl">{funding.countdown || '00:00:00'}</div>
                </div>
                <h5 className="text-lg">
                  Available for funding: <span className="font-semibold">{funding.available || 'N/A'}</span>
                </h5>

                <div className="progress__type space-y-2">
                  <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                    <div className="bg-blue-600 h-2" style={{ width: funding.progress || '0%' }} />
                  </div>
                  <p className="text-gray-600 text-sm">
                    <span className="font-semibold">{funding.investors || 0} Investors</span> |{' '}
                    <span className="font-semibold">
                      <i className="fa-solid fa-dollar-sign"></i> {funding.amount || 0}
                    </span>
                  </p>
                  <p className="text-gray-600 text-sm">
                    <i className="fa-solid fa-dollar-sign"></i> {funding.goal || 0} Goal
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {(occupancy.length ? occupancy : ['0%', '20%', '40%', '60%', '80%', '100%']).map((pct, i) => (
                    <button
                      key={i}
                      className={`px-3 py-1 rounded-full ${i === 0 ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
                    >
                      {pct}
                    </button>
                  ))}
                ...
                <form className="space-y-4">
                  <div className="input">
                    <label htmlFor="anNum" className="block text-gray-600">Annual return rate:</label>
                    <input id="anNum" type="number" placeholder="7.00%" className="w-full border border-gray-300 rounded p-2" />
                  </div>
                  <div className="input">
                    <label htmlFor="anNumIn" className="block text-gray-600">Invest</label>
                    <input id="anNumIn" type="number" placeholder="€ 500" className="w-full border border-gray-300 rounded p-2" />
                  </div>
                  <div className="input">
                    <label htmlFor="anNumInTwo" className="block text-gray-600">Earn</label>
                    <input id="anNumInTwo" type="number" placeholder="€ 35.00" className="w-full border border-gray-300 rounded p-2" />
                  </div>
                  ...
                  <button type="submit" className="button button--effect w-full py-2">Invest Now</button>
                </form>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg space-y-4">
                ...
                <a href="/blog" className="underline">Read More</a>
              </div>
                ...
                {updates.map((u, i) => (
                  <div key={i} className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <a href={u.link} className="text-blue-600">{u.text}</a>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="p__gallery py-16 bg-gray-50" id="gallery">
        <div className="container mx-auto px-4 space-y-8">
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            {gallery.map((img, i) => (
              <a key={i} href={img}>
                <img src={img} alt={`Property Image ${i + 1}`} className="w-full rounded-lg shadow-lg" />
              </a>
            ))}
          </div>
        </div>
      ...
      {/* The rest of your page (similar properties, CTA, footer) */}
      <Footer />
    </>
  )
}
